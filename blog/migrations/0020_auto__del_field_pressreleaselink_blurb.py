...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PressReleaseLink.blurb'
        db.delete_column(u'blog_pressreleaselink', 'blurb')


    def backwards(self, orm):
        # Adding field 'PressReleaseLink.blurb'
        db.add_column(u'blog_pressreleaselink', 'blurb',
                      self.gf('django.db.models.fields.TextField')(default=datetime.datetime(2013, 12, 20, 0, 0)),
                      keep_default=False)
