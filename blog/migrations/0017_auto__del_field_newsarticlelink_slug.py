...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NewsArticleLink.slug'
        db.delete_column(u'blog_newsarticlelink', 'slug')


    def backwards(self, orm):
        # Adding field 'NewsArticleLink.slug'
        db.add_column(u'blog_newsarticlelink', 'slug',
