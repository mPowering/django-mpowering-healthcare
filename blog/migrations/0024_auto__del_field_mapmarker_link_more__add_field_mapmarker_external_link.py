...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MapMarker.link_more'
        db.delete_column(u'blog_mapmarker', 'link_more')

        # Adding field 'MapMarker.external_link'
        db.add_column(u'blog_mapmarker', 'external_link',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MapMarker.coordinates'
        db.add_column(u'blog_mapmarker', 'coordinates',
                      self.gf('django.db.models.fields.CharField')(default='0,0', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MapMarker.link_more'
        db.add_column(u'blog_mapmarker', 'link_more',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'MapMarker.external_link'
        db.delete_column(u'blog_mapmarker', 'external_link')
    ...
    models = {
        ...
        u'blog.mapmarker': {
            ...
            'coordinates': ('django.db.models.fields.CharField', [], {'default': "'0,0'", 'max_length': '200'}),
